...
== copyright.txt ==
The copyright used for Ouroborus: the open-source portion of OOOii code. NOT ALL CODE IS OPEN SOURCE. http://code.google.com/p/oooii/ is the open source repository.
...
== oFXC.* ==
* Defines a custom build rule for compiling HLSL shaders. Right-click on a project that requires shaders, select "Build Customizations" and from the dialog check or browse to find oFXC. Once enabled, right-click on an HLSL file in the project for its properties and change the General|Item Type to FXC. Another property page option will appear called FXC that will give all the compiler options.
...
== VS2010_P4ExtTools.vssettings ==
See above: oP4Edit/oP4Revert
