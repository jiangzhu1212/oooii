...
%else
  %ifidn __OUTPUT_FORMAT__,x64
    ...
    %define     end_ptr     r10
    %define     ret_var     r11
	;oooii-eric fix broken enter/exit code
	; Using unaligned mov's which is slow. since rsp is in use
	; I didn't feel like finding an unused resgister. its just 2
	; slow instructions anyway, and I only did this in this file.
