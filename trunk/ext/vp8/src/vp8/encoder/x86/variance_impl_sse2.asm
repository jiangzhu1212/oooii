...
sym(vp8_get16x16var_sse2):
	...
	;oooii-eric - bug in vp8, they forgot to add the macro to save/restore required resisters to the stack. can cause calling code to fail when a register gets overwritten unexpectedly
    SAVE_XMM
    push rbx
    push rsi
    push rdi
