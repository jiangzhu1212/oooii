...
oMATH_ELBFNS(oMax, __max); // not named max to avoid name and macro collision
oMATH_ELBFNS(oMin, __min); // not named max to avoid name and macro collision
oMATH_ELUFNS(step);
...
// float noise(const float4& x); // @oooii-tony: not yet implemented
